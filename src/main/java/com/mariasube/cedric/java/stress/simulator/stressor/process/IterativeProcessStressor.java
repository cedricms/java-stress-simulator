...
@Slf4j
public class IterativeProcessStressor extends AbstractStressor {
    ...
    public void stress() {
        for (int i = 0; i < MAX_OBJECTS; i++) {
            ...
            long result = mathService.calculateRandomIterativeFibonacci();

            log.debug("MathService iterative Fibonacci : " + result);
        }
    }
}
